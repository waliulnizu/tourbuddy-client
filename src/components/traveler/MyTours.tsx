...
function MyTours() {
  ...
  const [form, setForm] = useState<PostFormData>({ title: '', amount: '', phone: '', gender: '', date_from: '', date_to: '', place_from: '', place_to: '', details: '' });
  ...
  const resetForm = () => {
    setForm({ title: '', amount: '', phone: '', gender: '', date_from: '', date_to: '', place_from: '', place_to: '', details: '' });
    setFile(null);
    setEditing(null);
    setShowForm(false);
  };
